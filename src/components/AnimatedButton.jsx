...
const AnimatedButton = ({ 
  ...
  const baseStyle = {
    position: 'relative',
    padding: '8px 24px',
    background: variant === 'secondary' ? '#f0f0f0' : '#fec195',
    fontSize: '14px',
    fontWeight: '500',
    color: variant === 'secondary' ? '#181818' : '#181818',
    cursor: 'pointer',
    border: variant === 'secondary' ? '1px solid #ddd' : '1px solid #fec195',
    borderRadius: '8px',
  ...
  const hoverStyle = {
    ...
    background: variant === 'secondary' 
      ? 'linear-gradient(85deg, #f0f0f0, #e0e0e0, #d0d0d0, #e0e0e0, #f0f0f0)'
      : 'linear-gradient(85deg, #fec195, #fcc196, #fabd92, #fac097, #fac39c)',
    ...
    <>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.animation = hoverStyle.animation;
        }}
        onMouseLeave={(e) => {
      ...
      >
        ...
        <div className="icon-1" style={icon1Style}>
          <svg
        ...
        <div className="icon-3" style={icon3Style}>
          <svg
            xmlnsXlink="http://www.w3.org/1999/xlink"
